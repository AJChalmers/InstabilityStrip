...
int main(){
	...
	char outputFileName_ForBlueEdge[30] = "BlueEdge_SetA.dat"; //File with model parameters on the blue edge
	char outputFileName_ForPositiveGrowthModels[30] = "PostiveGrowth_SetD.dat"; //File with model parameters that have positve growth rates
	...
	if(GetFirstNegativeGrowthRateModels){
		...
		ofstream outFile(outputFileName_ForBlueEdge);
		outFile<<setw(5)<<"Model"<<setw(20)<<"z"<<setw(20)<<"x"<<setw(20)<<"M"<<setw(20)<<"L"<<setw(20)<<"T"<<endl; //Header
		//outFile<<""<<endl;
			...
			if(inFile.good()){
				...
				if(LINAi != 0){
					...
					if(growth[LINAi] < 0. && growth[LINAi-1] > 0.){
						...
						outFile<<setw(5)<<Mod[i]<<setw(20)<<z[i]<<setw(20)<<x[i]<<setw(20)<<M[i]<<setw(20)<<L[i]<<setw(20)<<T[i]<<endl;
	...
	if(GetPositiveGrowthRateModels){
		...
		cout<<"Creating output file"<<endl;
		ofstream outFile(outputFileName_ForPositiveGrowthModels);
		outFile<<setw(5)<<"Model"<<setw(20)<<"z"<<setw(20)<<"x"<<setw(20)<<"M"<<setw(20)<<"L"<<setw(20)<<"T"<<endl; //Header
		//outFile<<""<<endl;
