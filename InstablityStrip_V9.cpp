		...
		if(GetFirstNegativeGrowthRateModels){
			...
			for(int m1 = 0; m1 < NumOfModes; m1++){
				...
				if(m1 == 3){
					...
					ofstream outFileBlueThirdO(ThirdO_outputFileName_ForBlueEdge);
				...
				if(m1 == 4){
					...
					ofstream outFileBlueForthO(ForthO_outputFileName_ForBlueEdge);
				...
				if(m1 == 5){
					...
					ofstream outFileBlueFifthO(FifthO_outputFileName_ForBlueEdge);
				...
				if(m1 == 6){
					...
					ofstream outFileBlueSixthO(SixthO_outputFileName_ForBlueEdge);
				...
				if(m1 == 7){
					...
					ofstream outFileBlueSeventhO(SeventhO_outputFileName_ForBlueEdge);
				...
				if(m1 == 8){
					...
					ofstream outFileBlueEighthO(EighthO_outputFileName_ForBlueEdge);
				...
				if(m1 == 9){
					...
					ofstream outFileBlueNinethO(NinethO_outputFileName_ForBlueEdge);
		...
		if(GetPositiveGrowthRateModels){
			...
			for(int m2 = 0; m2 < NumOfModes; m2++){
				...
				if(m2 == 3){
					...
					ofstream outFilePosThirdO(ThirdO_outputFileName_ForPositiveGrowthModels);
				...
				if(m2 == 4){
					...
					ofstream outFilePosForthO(ForthO_outputFileName_ForPositiveGrowthModels);
				...
				if(m2 == 5){
					...
					ofstream outFilePosFifthO(FifthO_outputFileName_ForPositiveGrowthModels);
				...
				if(m2 == 6){
					...
					ofstream outFilePosSixthO(SixthO_outputFileName_ForPositiveGrowthModels);
				...
				if(m2 == 8){
					...
					ofstream outFilePosEighthO(EighthO_outputFileName_ForPositiveGrowthModels);
				...
				if(m2 == 9){
					...
					ofstream outFilePosNinethO(NinethO_outputFileName_ForPositiveGrowthModels);
