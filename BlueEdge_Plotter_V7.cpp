...
int main(){
	...
	if(!GetOnlyModelsWithDefinedPeriodRange){
		...
		if(GetFirstNegativeGrowthRateModels){
			...
			outFileBlue<<setw(5)<<"Model"<<setw(20)<<"z"<<setw(20)<<"x"<<setw(20)<<"M"<<setw(20)<<"L"<<setw(20)<<"T"<<setw(20)<<"Lin Period"<<setw(20)<<"Growth rate"<<setw(20)<<"logT"<<setw(20)<<"logP"<<setw(20)<<"logM"<<endl; //Header
			//outFile<<""<<endl;
		}
		...
		if(GetPositiveGrowthRateModels){
			...
			outFilePos<<setw(5)<<"Model"<<setw(20)<<"z"<<setw(20)<<"x"<<setw(20)<<"M"<<setw(20)<<"L"<<setw(20)<<"T"<<setw(20)<<"Lin Period"<<setw(20)<<"Growth rate"<<setw(20)<<"logT"<<setw(20)<<"logP"<<setw(20)<<"logM"<<endl; //Header
			//outFile<<""<<endl;
		}
				...
				if(GetFirstNegativeGrowthRateModels){
					...
					if(LINAi != 0){
						...
						if(growth[LINAi] < 0. && growth[LINAi-1] > 0.){
							...
							outFileBlue<<setw(5)<<Mod[i]<<setw(20)<<z[i]<<setw(20)<<x[i]<<setw(20)<<M[i]<<setw(20)<<L[i]<<setw(20)<<T[i]<<setw(20)<<period[LINAi]<<setw(20)<<growth[LINAi]<<setw(20)<<log(T[i])<<setw(20)<<log(period[LINAi])<<setw(20)<<log(M[i])<<endl;
				...
				if(GetPositiveGrowthRateModels){
					...
					if(LINAi != 0){
						...
						if(growth[LINAi] > 0){
							...
							outFilePos<<setw(5)<<Mod[i]<<setw(20)<<z[i]<<setw(20)<<x[i]<<setw(20)<<M[i]<<setw(20)<<L[i]<<setw(20)<<T[i]<<setw(20)<<period[LINAi]<<setw(20)<<growth[LINAi]<<setw(20)<<log(T[i])<<setw(20)<<log(period[LINAi])<<setw(20)<<log(M[i])<<endl;
