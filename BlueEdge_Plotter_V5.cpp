...
int main(){
	...
	int NumOfModels = 100; //20412 is total TypeII models
	int NumOfModes = 10;
	...
	char outputFileName_ForBlueEdge[30] = "BlueEdge_SetD_Test.dat"; //File with model parameters on the blue edge
	char outputFileName_ForPositiveGrowthModels[30] = "PostiveGrowth_SetD_Test.dat"; //File with model parameters that have positve growth rates
	...
	if(GetFirstNegativeGrowthRateModels){
		...
		outFileBlue<<setw(5)<<"Model"<<setw(20)<<"z"<<setw(20)<<"x"<<setw(20)<<"M"<<setw(20)<<"L"<<setw(20)<<"T"<<endl; //Header
		//outFile<<""<<endl;
	}
	...
	if(GetPositiveGrowthRateModels){
		...
		outFilePos<<setw(5)<<"Model"<<setw(20)<<"z"<<setw(20)<<"x"<<setw(20)<<"M"<<setw(20)<<"L"<<setw(20)<<"T"<<endl; //Header
		//outFile<<""<<endl;
	}
			...
			if(GetFirstNegativeGrowthRateModels){
				...
				if(LINAi != 0){
					...
					if(growth[LINAi] < 0. && growth[LINAi-1] > 0.){
						...
						outFileBlue<<setw(5)<<Mod[i]<<setw(20)<<z[i]<<setw(20)<<x[i]<<setw(20)<<M[i]<<setw(20)<<L[i]<<setw(20)<<T[i]<<endl;
			...
			if(GetPositiveGrowthRateModels){
				...
				if(LINAi != 0){
					...
					if(growth[LINAi] > 0){
						...
						outFilePos<<setw(5)<<Mod[i]<<setw(20)<<z[i]<<setw(20)<<x[i]<<setw(20)<<M[i]<<setw(20)<<L[i]<<setw(20)<<T[i]<<endl;
